...
import 'package:patterns_block_2/blocs/list_post_cubit.dart';
  ...
  return Slidable(
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: [
          // Username
          Text(contact.username.toUpperCase(), style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 18),),

          SizedBox(height: 5,),

          // Phone number
          Text(contact.phoneNumber ?? 'a', style: TextStyle(color: Colors.black, fontSize: 16),),
        ],
      ),
    ),
